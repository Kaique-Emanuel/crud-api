...
public class UsuarioController {
    ...
    public Map<String, String> usuarioLogado(Authentication auth) {
        ...
        resposta.put("login", u.getLogin());
        resposta.put("email", u.getEmail() != null ? u.getEmail() : "");
        resposta.put("role", u.getRole() != null ? u.getRole() : "USER");
        resposta.put("fotoUrl", u.getFotoUrl() != null ? u.getFotoUrl() : "");
        return resposta;
    }
    ...
    @PostMapping("/foto")
    public ResponseEntity<Map<String, String>> atualizarMinhaFoto(@RequestBody Map<String, String> body, Authentication auth) {
